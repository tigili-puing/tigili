...
import CDNImage from '../../components/CDNImages.astro'
...
<CDNImages src="https://cdn.maunguli.com/cdn?src=images/posts/plesteran/membuat-acuan-plesteran.jpeg" alt="Pemasangan acuan plester" width={800} height={600} />
...
<CDNImages src="https://cdn.maunguli.com/cdn?src=images/posts/plesteran/laser-level-plesteran.jpeg" alt="Tembok yang sudah diberi acuan" width={800} height={600} />
*Acuan sudah terpasang sebelum diplester merata*

<CDNImages src="https://cdn.maunguli.com/cdn?src=images/posts/plesteran/phinising-plesteran.jpeg" alt="Hasil akhir dinding setelah diplester" width={800} height={600} />
*Hasil akhir dinding setelah diplester halus dan presisi*

<CDNImages src="https://cdn.maunguli.com/cdn?src=images/posts/plesteran/kenek-adukan.jpeg" alt="Pencampuran adukan plester" width={800} height={600} />
*Pencampuran adukan sebelum diaplikasikan ke dinding*

<CDNImages src="laser-level-plesteran.jpeg" alt="Tembok diplester dengan bantuan laser" width={800} height={600} />
