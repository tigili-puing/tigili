...
description: Pada salah satu proyek renovasi rumah terbaru kami, tim Maunguli dipercaya untuk melakukan pemasangan plafon di area ruang dalam rumah.
author: Tim Maunguli
category: Renovasi
image:
...
---
import SmartImageCDN from '../../components/CDNImages.astro';
...
<CDNImages
  src="https://cdn.maunguli.com/cdn?src=images/posts/pemasngan-plafon-minimalis.jpeg&format=webp"
  alt="Plafon drop ceiling"
  width={800}
...
<CDNImages
  src="https://cdn.maunguli.com/cdn?src=images/posts/Pemasangan-plafon.jpeg"
  alt="Plafon drop ceiling"
  width={800}
  class="rounded-xl my-6"
