...
category: exterior
image:
  url: https://cdn.maunguli.com/cdn?src=images/posts/tumpukan-pasir.jpeg&format=webp&w=800
  alt: Tumpukan Pasir
youtubeId: 5mtwwemvbHI
---
import { Image } from "../../assets/img/tumpukan-pasir.jpeg";
import pasir from "../../assets/img/tumpukan-pasir.jpeg"
...
<CDNImages src={pasir} alt="tumpukan pasir"/>
